function [cpx,cpy,cpz, sdist, bdy] = cpSphereInterior(x,y,z, R, cen)
%CPSPHEREINTERIOR  Closest point function for a sphere.
%   [cpx,cpy,cpz,sdist,bdy] = cpSphere(x,y,z, R) returns the
%   closest point and distance to (x,y,z).  If R is omitted it
%   defaults to a unit sphere, centered at the origin.
%
%   [cpx,cpy,cpz,sdist,bdy] = cpSphere(x,y,z, R, [xc,yc,zc]) is a sphere
